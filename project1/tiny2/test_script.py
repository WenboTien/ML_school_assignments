...
from wtian6_tian.networks import xor_net, mlnn
...
def test_waldo():
    ...
    training_data, training_labels = dg.query_data(samples = 1000)
    # print [i/255 for i in training_data[0]]
    print 'waldo  training: '
...
if __name__ == '__main__':
    # training_data, validation_data, teat_data = mnist_loader.load_data_wrapper()
    #
