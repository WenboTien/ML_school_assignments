...
class waldo(object):
    ...
    def _query_sample (self, img):
        ...
        img_reshaped = misc.imresize(img, size=rshp)
        img_sample = random_noise(img_reshaped, mode = 'gaussian', var = self.var, clip = True)
        img_sample = random_noise(img_sample, mode = 's&p', clip = True) * 255
